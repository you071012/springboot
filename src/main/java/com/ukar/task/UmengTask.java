...
//    @Scheduled(cron="0 0/10 * * * ?") //每10分钟执行一次
    public void task() {
        try{
            ...
            logger.info(i + end + "执行完毕，" + "文件切换为：" + i + end + "准备执行................................");
